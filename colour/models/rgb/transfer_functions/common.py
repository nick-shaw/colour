...
def legal_to_full(CV, bit_depth=10, in_int=False, out_int=False):
    """
    Converts given code value from legal range (studio swing) to full range
    (full swing).

    Parameters
    ----------
    CV : array_like
        Legal range code value :math:`CV`.
    bit_depth : int, optional
        Bit depth used for conversion.
    in_int : bool, optional
        Whether to treat the input values as integer code values.
        Default is `False`.
    out_int : bool, optional
        Whether to return values as integer code values. Default is
        `False`.

    Returns
    -------
    ndarray
        Full range code value :math:`CV`.
...
def full_to_legal(CV, bit_depth=10, in_int=False, out_int=False):
    """
    Converts given code value from full range (full swing) to legal range
    (studio swing).
    ...
    in_int : bool, optional
        Whether to treat the input values as integer code values.
    out_int : bool, optional
        Whether to return values as integer code values
